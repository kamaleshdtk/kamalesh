  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4" aria-modal="true" role="dialog">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-6 sm:p-8">
        <h2 className="text-2xl font-bold text-text-primary">Screenshot Failed</h2>
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="w-full text-center px-4 py-8 border-2 border-dashed border-gray-300 rounded-lg hover:border-primary hover:bg-primary/5 transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
          >
            {image ? (
