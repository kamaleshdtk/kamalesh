...
const AuthPage: React.FC<AuthPageProps> = ({ onLogin }) => {
  return (
    <div className="flex items-center justify-center min-h-[80vh]">
      <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-gray-800 shadow-form-soft rounded-2xl dark:border dark:border-gray-700">
        ...
        <div className="space-y-4">
            ...
            <button
              onClick={onLogin}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white dark:bg-gray-700 text-text-primary dark:text-white border border-gray-200 dark:border-gray-600 font-semibold rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300"
            >
